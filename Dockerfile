...
RUN cp /usr/lib64/libltdl.so.7.3.0 /opt/app/bin/libltdl.so.7
RUN cp /usr/lib64/libxml2.so.2.9.1 /opt/app/bin/libxml2.so.2
RUN cp /usr/lib64/liblzma.so.5.2.2 /opt/app/bin/liblzma.so.5
